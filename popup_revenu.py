...
class PopupRevenu(Toplevel):
    def __init__(self, application, *args, **kwargs):
        ...
        self.__configurer_popup_revenu__()
        # Rendre cette fenêtre popup modale par rapport à la fenêtre principale
        self.grab_set()
        self.focus_force()

    def __configurer_popup_revenu__(self):
        # Configuration des propriétés de la fenêtre popup revenu
        self.title("Ajouter un revenu")
        # Configuration des dimensions et positions initiale de la popup d'ajout de revenu (centrée sur l'écran)
        ...
        self.iconbitmap('./icone_revenu.ico')
        ...
        texte_operation = StringVar(value='Salaire')
        ...
        texte_montant = StringVar(value='+1500.00')
        ...
        zone_boutons.pack()
        self.bouton_valider = Button(zone_boutons, text="Valider", width=7, command=self.__valider_revenu__)
    ...
    def __valider_revenu__(self):
        ...
        # Insérer la nouvelle opération de revenu dans l'historique des opérations
        self.application.ajouter_revenu(nom_operation, montant_operation)
        # Fermer cette popup après validation et insertion du nouveau revenu
        self.quitter()
